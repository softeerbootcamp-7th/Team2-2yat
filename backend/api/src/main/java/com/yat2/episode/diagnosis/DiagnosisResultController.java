...
import com.yat2.episode.diagnosis.dto.NeedApproveDataDto;
...
public class DiagnosisResultController {
    ...
    @PostMapping()
    public ResponseEntity<DiagnosisSimpleDto> createMindmap(@RequestAttribute(USER_ID) long userId, @RequestBody MindmapArgsReqDto reqBody) {
